    ...
    <div className="h-screen w-screen flex pt-16">
      ...
      <div className="w-1/2 bg-red-500 flex flex-col justify-center items-center text-white relative overflow-hidden">
        ...
        <div className="z-10 text-center px-8">
          ...
          <button className="bg-white text-red-600 px-6 py-3 rounded-md border-2 border-red-600 font-semibold hover:bg-red-600 hover:text-white transition duration-300">
            UPLOAD NOW
          </button>
        </div>
      </div>
      ...
      <div className="w-1/2 bg-blue-600 flex flex-col justify-center items-center text-white relative overflow-hidden">
        ...
        <div className="z-10 text-center px-8">
          ...
          <button className="bg-white text-blue-600 px-6 py-3 rounded-md border-2 border-blue-600 font-semibold hover:bg-blue-600 hover:text-white transition duration-300">
            UPLOAD NOW
          </button>
        </div>
      </div>
